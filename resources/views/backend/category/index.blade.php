        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!--           
                <h3>Category List
                  <a class="btn btn-success float-sm-right" href=""><i class="fa fa-plus-circle"></i>Add Category</a>
                </h3> 
                <h3>Add Category
                  <a class="btn btn-success float-sm-right" href=""><i class="fa fa-list"></i>Category List</a>
                </h3>
                <td>
              ...
              <div class="card-body">
                ...
                @foreach($category as $row)
                  <tr>
                    ...
                    <td>
                      <a title="Edit" class="btn btn-sm btn-info" href="{{ URL::to('edit/category/'.$row->id) }}"><i class="fa fa-edit"></i></a>
                      <a title="Delete" class="btn btn-sm btn-danger" id="delete" href="{{route('delete.category',$row->id)}}"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach  
               </tbody>
