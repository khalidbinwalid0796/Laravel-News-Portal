              ...
              <div class="card-body">
                ...
                @foreach($subcategory as $row)
                  <tr>
                    ...
                    <td>
                      <a title="Edit" class="btn btn-sm btn-info" href="{{ URL::to('edit/subcategory/'.$row->id) }}"><i class="fa fa-edit"></i></a>
                      <a title="Delete" class="btn btn-sm btn-danger" id="delete" href="{{route('delete.subcategory',$row->id)}}"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                @endforeach  
               </tbody>
